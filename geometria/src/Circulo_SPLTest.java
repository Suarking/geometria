...
class Circulo_SPLTest {
	
	private Circulo_SPL circulo1, circulo2, circulo3;

	@Before
	public void inicioPruebas() { //Creamos los objetos
		circulo1 = new Circulo_SPL(7, "circulo");
		circulo2 = new Circulo_SPL(0, "circulo");
		circulo3 = new Circulo_SPL(-3, "circulo");
	}
